...
## Overview  
This repository improves upon **FAMFS (fabric-attached memory file system)** by adding **file removal functionality** and **non-contiguous allocation**. These enhancements allow FAMFS to properly free and reuse storage space after file deletions, preventing false "Out of Space" errors.  
